        ...
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="prasanna" name="fname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="poudel" name="lname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="bktpur" name="city">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
